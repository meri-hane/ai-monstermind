...
# with open('stored_objects/easy_trial_constant.pickle', 'wb') as f:
#     pickle.dump(lookup_table, f)

# print("Successfully loaded!")
# Example usage: Print the lookup table for a specific guess
example_guess = ('P', 'B', 'G', 'O')
...
# # Shuffle the possible guesses for randomization
# random.shuffle(all_combinations)

# # Create the lookup table using Knuth's Algorithm
# lookup_table = {}
...
# # Store the lookup table as a pickle file
# # with open('stored_objects/easy_trial.pickle', 'wb') as f:
# #     pickle.dump(lookup_table, f)

# # print("Successfully loaded!")

# example_guess = ('Y', 'Y', 'B', 'O')
# print(f"Lookup table for guess {example_guess}:")
# print(lookup_table[example_guess])